...
module.exports = {
  sendVerification: function (target, username, token) {
    ...
    let message = {
      ...
      html: "Hello <strong>" + username + "</strong><br/>Anda telah mendaftarkan email <strong>" + target + "</strong> untuk akun Safe-t. Silahkan klik tautan berikut untuk memverifikasi akun anda.<br/>http://localhost:3000/login/" + token // html body
    };
