...
class Registered extends Component {
  ...
  getData = () => {
    axios.get(localStorage.getItem('serverAPI') + '/user/status/0')
      .then(res => {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" xl="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Data User Terdaftar</strong>
              </CardHeader>
              <CardBody>
                <MDBDataTable
                  striped
                  ...
                  <ModalBody className="modal-body-display">
                    <Col sm="12" lg="5" className="m-auto">
                      <Row>
                        ...
                        <div className="w-100 py-2"></div>
                        <Col xs="3">Status</Col>
                        <Col xs="9" className="border-bottom mt-auto" style={viewStyle}>Registered / Not Verified</Col>
                        <div className="w-100 py-2"></div>
